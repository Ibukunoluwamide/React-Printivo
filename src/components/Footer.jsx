...
const Footer = () => {
  return (
    <footer className="text-center text-lg-start bg-white ">
      ...
      >
        <div className="p-3">
          <h3 className="dm-family">Our amazing work got noticed by:</h3>
          <div className="row pt-3">
            <div className="col-lg">
              ...
              />
              <p>
                <a href="" className="nav-link text-decoration-underline ">
      ...
      <section className="footer-list p-5">
        <div className="container text-center text-md-start" >
          <div className="row ">
            <div className="col-md-3 col-xl-3 mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">Printivo</h6>
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">Make Money</h6>
              <ul className="list-unstyled">
                <li>
                  <a href="#!" className="text-reset">
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <h6 className="text-uppercase fw-bold mb-4 mt-4">Accepted Payments</h6>
              <img
                src="https://printivo.s3-us-west-2.amazonaws.com/files/temp/payment.png"
                alt="" className="col-12"
              />
              <h6 className="text-uppercase fw-bold mb-4 mt-4">Delivery</h6>
              <div>
                <img
      ...
      <div
        ...
        style={{ backgroundColor: "#CBCAC8" }}
      >
        © 2023 Copyright Printivo. All rights reserved.
      </div>
    </footer>
  )
}
